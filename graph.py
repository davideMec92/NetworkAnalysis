...
array_dir = [ source_dir + "/socfb-Simmons81/socfb-Simmons81.txt", source_dir + "/ca-CondMat/ca-CondMat.txt", source_dir + "/soc-gplus/soc-gplus.txt" ]

data = []

for filename in array_dir:
...
layout = {"title": "Comparative of degree sequences", 
          "xaxis": {"title": "Sequence", }, 
          "yaxis": {"title": "Node Degree"}}

fig = go.Figure(data=data, layout=layout)

py.plot(data, filename = "Comparative of degree sequences")
